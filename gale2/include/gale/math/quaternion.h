...
class Quaternion
{
  public:
    ...
    /// Returns a random normalized quaternion generated by \a r.
    template<typename RT,class RI>
    static Quaternion random(RandomBase<RT,RI>& r) {
        Quaternion q(Vec::random(r),r.random0ExclN(2*Constants<T>::PI()));
        q.normalize();
        return q;
    }
